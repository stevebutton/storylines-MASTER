...
export default function Reference() {
  const backupCode = `import React, { useState, useEffect, useRef } from 'react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold text-slate-800 mb-4">
            ProjectInterface Backup Reference
          </h1>
          <p className="text-slate-600 mb-6">
            This is the backup code from <code className="bg-slate-100 px-2 py-1 rounded">pages/ProjectInterface.backup.js</code>
          </p>
