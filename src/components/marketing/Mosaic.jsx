...
const PROSE_CSS = `
  ...
  .description-content li { font-family: 'Montserrat', sans-serif; font-size: 17px; font-weight: 300; line-height: 1.3em; color: rgba(255,255,255,0.9); margin-bottom: 4px; }
          ...
          {cards.map((panel, idx) => (
            <div
              ...
              style={{
                ...
                animation: `mosaicPanelIn 2s ease ${idx + 1}s both`,
              }}
