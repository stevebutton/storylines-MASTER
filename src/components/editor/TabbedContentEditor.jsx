      ...
      <div className="space-y-6">
                <Card>
                    <CardContent className="pt-6 space-y-4">
                        <div>
                            <Label className="text-lg font-semibold uppercase leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Title *</Label>
                            <Input
                value={item.title || ''}
                ...
                style={{ fontSize: '0.9rem', lineHeight: '1.2rem' }} />
                        ...
                        <div>
                            <Label className="text-sm font-medium uppercase leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Subtitle</Label>
                            <ReactQuill
                value={item.subtitle || ''}
                ...
                modules={{
                  ...
                  ['link']]
                        ...
                        {/* Opening Map View */}
                        <div>
                            <Label className="text-sm font-medium uppercase leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Story Opening Map View</Label>
